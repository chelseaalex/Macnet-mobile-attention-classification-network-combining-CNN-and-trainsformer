...
class MOAT(nn.Module):
    ...
    def __init__(
        ...
        self.MOAT1 = nn.ModuleList([
            MOATBlock(in_channels=channels[0] if i == 0 else channels[1],
        ...
        self.MBConv2 = nn.ModuleList([
            MBConvBlock(in_channels=channels[1] if i == 0 else channels[2],
...
if __name__ == '__main__':
    network = moat_0(use_window=False, num_classes=4)
